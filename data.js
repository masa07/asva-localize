...
"en":[
      ...
      " So, the format is ...",
      "Only [localised phrase] should be replaced with localized words.",
      "Resources",
      "Resources for localization is downloadable from following link as a zip file. ",
      " And you could contribute your work to tweet location of your localised file with #ASVA or post it on facebook.",
          ""], // End of English
...
"ja":[
      ...
      "翻訳できたファイルのアドレスを　'#ASVA'でツイートするか or Facebookに投稿してください.",
      ""] // End of Japanese
}; //End Of Hash Array
