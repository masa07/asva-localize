...
{	"title":"音量を選択する",
"text":"ナビゲーションバーのタイトルには現在の音量が表示されています。各項目をタップすることで音量を簡単に変更できます。項目の内容を編集したい場合は各項目右端の詳細ボタンをタップしてください。項目を追加する場合は、ナビゲーションバー右端の'+'ボタンをタップしてください。左上の'編集'ボタンで項目の削除や順序の変更ができます。",
"imgSource":"list/ja/list.png"},
...
"imgSource":"list/ja/edit.png"},

// 2
{	"title":"アシスタント",
"text":"「説明書」はこの画面を表示します。「メッセージを送る」はこのアプリに関するご意見を様々な方法で送ることができます。「フェイスブックページ」はこのアプリに関する情報を表示します。「データを移行する」ではタップして表示されるアプリに音量リストを送ることができます。",
"imgSource":"list/ja/assistant.png"},
